        ...
        <div className="flex items-center gap-x-6 mt-6 h-8">
          ...
          >
            ...
            >
              <path
                fill="#25D366"
                d="M16 0C7.2 0 0 7.2 0 16c0 2.8.7 5.5 2 7.9L0 32l8.3-2.2A15.9 15.9 0 0 0 16 32c8.8 0 16-7.2 16-16S24.8 0 16 0z"
              />
              <path
                fill="#FFF"
                d="M24.3 19.2c-.4-.2-2.3-1.1-2.7-1.3-.4-.2-.8-.2-1.1.3s-1 1.3-1.2 1.6c-.2.2-.5.3-.9.1-.4-.2-1.6-.6-3-1.9a11 11 0 0 1-2-2.5c-.2-.3 0-.6.2-.8l.6-.7c.2-.3.3-.5.5-.9.2-.4 0-.7 0-.9s-1.1-2.7-1.5-3.7c-.4-1-.8-.8-1.1-.8H9c-.3 0-.6 0-.9.4-.2.4-1.2 1.3-1.2 3.1 0 1.8 1.3 3.5 1.4 3.8.2.2 2.6 4 6.3 5.6 3.7 1.6 3.7 1.1 4.4 1 1.1-.1 2.2-.9 2.5-1.8.3-.9.3-1.6.2-1.7-.1-.2-.4-.3-.9-.5z"
              />
            </svg>
          </a>
          {/* Email */}
